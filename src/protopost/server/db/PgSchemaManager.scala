    ...
    def upMigrateFrom_0() : Task[Unit] =
      ZIO.attemptBlocking:
        ...
        Using.resource( conn.createStatement() ): stmt =>
          ...
          PgSchema.V1.Type.PublicationEventType.create( stmt )
          ...
          PgSchema.V1.Table.SubscribedFeed.create( stmt )
          PgSchema.V1.Table.DestinationFeedSubscription.create( stmt )
          PgSchema.V1.Table.PostComment.create( stmt )
          ...
          PgSchema.V1.Sequence.SubscribedFeedId.create( stmt )
